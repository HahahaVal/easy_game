...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(1985910903u);
			...
			// AI
			meta = BEHAVIAC_NEW AgentMeta(906959332u);
			AgentMeta::GetAgentMetas()[3193132154u] = meta;
			meta->RegisterMethod(1543007619u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_AI_BT_DoAction));
			meta->RegisterMethod(3874352801u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_AI_BT_SelectSkill));
			meta->RegisterMethod(1334113672u, BEHAVIAC_NEW CAgentMethod< behaviac::EBTStatus >(FunctionPointer_AI_BT_SelectTarget));
			meta->RegisterMethod(1045109914u, BEHAVIAC_NEW CAgentStaticMethodVoid_1<char*>(FunctionPointer_AI_LogMessage));
			meta->RegisterMethod(2521019022u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorAdd());
			meta->RegisterMethod(2306090221u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorClear());
			meta->RegisterMethod(3483755530u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorContains());
			meta->RegisterMethod(505785840u, BEHAVIAC_NEW CMethod_behaviac_Agent_VectorLength());
